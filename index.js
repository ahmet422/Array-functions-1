// Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      const needed = inventors.filter(p => p.year > 1499 && p.year < 1600);
      console.table(needed);
  
      // Array.prototype.map()
      // 2. Give us an array of the inventors first and last names
      const fullNames = inventors.map(p => p.first + " " + p.last);
      ...
      const byYears = inventors.sort((a,b) => (a.passed - a.year) - (b.passed-b.year));
      byYears.forEach(p => p.lived = p.passed - p.year);
      ...
      const byLastName = people.sort((a,b) => a.split(', ')[1] - b.split(', ')[1]);
